...
|---|---|---|
| P1. Core contract compiler/query ABI | In progress: Tasks 1-5 independently reviewed and complete | Resolve IDs/profiles/indexes/facts; compiled identity/manifest/capabilities; complete spec compile/query C ABI; C++ facade; committed deep-object/DAG regressions; golden/fuzz/native CI |
