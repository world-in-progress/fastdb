...
- P3 Tasks 1 and 2 now provide only the Core-private graph topology and logical
  authoring seams described below. Graph binary/layout/open/view/materialize,
