...
| [0002](0002-portable-payload-foundation-implementation-status.md) | Open (P1-P4 locally frozen; P5 and hosted evidence pending) | Frozen P2/P3 traceability and historical ABI-105, locally complete exact ABI-117 projections/codegen/hostile-output evidence, explicit platform limits, and remaining clean-cut/release gaps. |
