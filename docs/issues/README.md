...
| Issue | Status | Scope |
|---|---|---|
| [0001](0001-portable-payload-deferred-capabilities.md) | Open (D1 closed; D2-D6 open) | D1 graph direct construction is locally closed with executable P3 evidence; segmented backing, streaming authoring, additional guaranteed platforms, native Node/Go projections, and registry distribution remain tracked. |
| [0002](0002-portable-payload-foundation-implementation-status.md) | Open (P1-P5 locally frozen; hosted/release evidence pending) | Frozen P2/P3 traceability and historical ABI-105, locally complete exact ABI-117 projections/codegen/hostile-output evidence, local P5 readiness, retained package manifest and proven downstream isolated-consumer handoff, and remaining hosted/official-release evidence. |
