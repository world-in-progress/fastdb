...
| [0002](0002-portable-payload-foundation-implementation-status.md) | Open (P2 implementation in progress; Task 11 local gates green/final review pending; hosted evidence pending) | Current P2 traceability and remaining non-deferrable P2-P5 gaps, including pending hosted CI evidence for the 0.2.0 portable payload foundation. |
