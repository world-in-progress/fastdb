...
constexpr ErrorCase error_cases[] = {
    ...
    {FDB_PAYLOAD_E_RUNTIME_UNAVAILABLE, "RUNTIME_UNAVAILABLE"},
    {FDB_PAYLOAD_E_INVALID_TEXT_ENCODING, "INVALID_TEXT_ENCODING"},
    {FDB_PAYLOAD_E_BUILDER_LENGTH_OVERFLOW, "BUILDER_LENGTH_OVERFLOW"},
    {FDB_PAYLOAD_E_BUILDER_OUT_OF_BOUNDS, "BUILDER_OUT_OF_BOUNDS"},
    {FDB_PAYLOAD_E_BUILDER_RESOURCE_LIMIT, "BUILDER_RESOURCE_LIMIT"},
    {FDB_PAYLOAD_E_INVALID_OBJECT_HANDLE, "INVALID_OBJECT_HANDLE"},
    {FDB_PAYLOAD_E_UNREACHABLE_OBJECT, "UNREACHABLE_OBJECT"},
    ...
    {FDB_PAYLOAD_E_NON_CANONICAL_BINARY, "NON_CANONICAL_BINARY"},
    {FDB_PAYLOAD_E_INVALID_BINARY_VALUE, "INVALID_BINARY_VALUE"},
